...
import { Icon, Slide, SlideContent, SliderContainer, SliderNavigation } from './BlockStorySlider.styles';
        ...
        <div ref={sliderRef} className={`keen-slider`}>
          {slides.map((slide, index) => (
            <Slide className={`keen-slider__slide`} key={index}>
              {/* @Lothar TODO: Link naar desbetreffende pagina */}
              <Link href="#">
                <a>
                  <SlideContent>
                    <span>Project</span>
                    <h4>Beschermd thuis in Veenendaal</h4>
                  </SlideContent>
                  {/* @Lothar TODO: Hoe krijg ik de afbeelding van de desbetreffende pagina? */}
                  <Image src={`https://picsum.photos/378/500?img=${index}`} layout="fill" />
                </a>
              </Link>
            </Slide>
          ))}
